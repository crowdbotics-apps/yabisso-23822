"""yabisso_23822 URL Configuration
...
admin.site.site_header = "YaBisso"
admin.site.site_title = "YaBisso Admin Portal"
admin.site.index_title = "YaBisso Admin"

# swagger
api_info = openapi.Info(
    title="YaBisso API",
    default_version="v1",
    description="API documentation for YaBisso App",
)
